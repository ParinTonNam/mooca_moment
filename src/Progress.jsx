...
export default function Progress({screen}) {
 ...
 return <div className="journey-progress">
  <div className="journey-progress-label" key={step}><span>ขั้นตอนที่ {step} จาก 3</span><span className="journey-section">{label}</span><span className="journey-duration">ใช้เวลาประมาณ 2 นาที</span></div>
