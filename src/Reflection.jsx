...
export default function Reflection({screen,headingRef,onBack,draft,onChange,onSave}) {
 ...
 return <div className={`check-in-content reflection-content ${screen}-content`}>
  ...
  <div className="rest-buttons"><button type="button" className="continue" onClick={onSave}>ไปดูสรุปช่วงพักนี้<img src="/assets/imgIconArrowSmallRight.svg" alt=""/></button><button type="button" className="skip-button" onClick={onBack}>ยังไม่อยากเลือกตอนนี้</button></div>
 </div>;
}
